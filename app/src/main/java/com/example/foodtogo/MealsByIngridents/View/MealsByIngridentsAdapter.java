...
public class MealsByIngridentsAdapter extends RecyclerView.Adapter<MealsByIngridentsAdapter.ViewHolder> {
...
public MealsByIngridentsAdapter(Context context, List<Meal> values) {
...
@NonNull
@Override
public MealsByIngridentsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    LayoutInflater inflater = LayoutInflater.from(context);
    View itemView = inflater.inflate(R.layout.meal_item, parent, false);
    return new MealsByIngridentsAdapter.ViewHolder(itemView);
}

@Override
public void onBindViewHolder(@NonNull MealsByIngridentsAdapter.ViewHolder holder, int position) {
