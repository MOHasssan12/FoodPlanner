package com.example.foodtogo.MealsByIngridents.Presenter;

import com.example.foodtogo.MealsByCountries.View.MealsbyCountriesView;
import com.example.foodtogo.MealsByIngridents.View.MealsByIngridentsView;
...
public class MealsByIngridentsPresenter implements NetworkCallback {


    private MealsByIngridentsView _view;
    private Repo _repo;




    public MealsByIngridentsPresenter(MealsByIngridentsView _view, Repo _repo) {
        this._view = _view;
        this._repo = _repo;
    }

    public void getMeals(String ingridentName){
        _repo.getMealsByIngridents(ingridentName,this);
    }
