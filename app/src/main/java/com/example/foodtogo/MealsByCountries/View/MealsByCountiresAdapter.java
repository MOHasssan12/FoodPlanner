...
public class MealsByCountiresAdapter extends RecyclerView.Adapter<CategoriesMealsAdapter.ViewHolder> {
    ...
    public MealsByCountiresAdapter(Context context, List<Meal> values) {
